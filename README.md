...
* `ps3mca-ps1 z` for read directory and date set on PocketStation card.
* `ps3mca-ps1 r` for reading.
* `ps3mca-ps1 w` for writing (WARNING need a write.mcd file), (see doc/FAQ).
